...
public class FuLiaoInfoRecyclerViewAdapter extends RecyclerView.Adapter<FuLiaoInfoRecyclerViewAdapter.MyViewHodler> {
     ...
     */
    public FuLiaoInfoRecyclerViewAdapter(Context context, ArrayList<FuLiaoInfoBean> datas, int orientation) {
    ...
    public MyViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = View.inflate(context, R.layout.item_fuliao_info_recyclerview, null);
...
//                .fitCenter()                                //图片显示样式
    ...
    class MyViewHodler extends RecyclerView.ViewHolder {
        ...
        private TextView tv_fl_gongyinshang_id;
        private TextView tv_fl_id;
        private TextView tv_dh_id;
        private TextView tv_fl_bz;
        ...
        public MyViewHodler(View itemView) {
            ...
            tv_fl_gongyinshang_id = itemView.findViewById(R.id.tv_fl_gongyinshang_id);
            tv_fl_id = itemView.findViewById(R.id.tv_fl_id);
            tv_dh_id = itemView.findViewById(R.id.tv_dh_id);
            tv_fl_bz = itemView.findViewById(R.id.tv_fl_bz);
