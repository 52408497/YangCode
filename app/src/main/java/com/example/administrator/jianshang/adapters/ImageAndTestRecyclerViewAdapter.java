...
public class ImageAndTestRecyclerViewAdapter extends RecyclerView.Adapter<ImageAndTestRecyclerViewAdapter.MyViewHodler> {
     ...
     */
    public ImageAndTestRecyclerViewAdapter(Context context, ArrayList<String> datas,int orientation) {
